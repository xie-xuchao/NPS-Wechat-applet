...
var t = require("../common/color"), e = require("../common/component"), n = require("../common/utils"), i = require("../mixins/page-scroll");
...
e.VantComponent({
    ...
    mixins: [ i.pageScrollMixin(function(t) {
    ...
    methods: {
        ...
        setAnchorsRect: function() {
            ...
            return Promise.all(this.children.map(function(e) {
                return n.getRect.call(e, ".van-index-anchor-wrapper").then(function(n) {
                    Object.assign(e, {
                        height: n.height,
        ...
        setListRect: function() {
            var t = this;
            return n.getRect.call(this, ".van-index-bar").then(function(e) {
                Object.assign(t, {
                    height: e.height,
        ...
        setSiderbarRect: function() {
            var t = this;
            return n.getRect.call(this, ".van-index-bar__sidebar").then(function(e) {
                t.sidebar = {
                    height: e.height,
                    top: e.top
                };
        ...
        getAnchorRect: function(t) {
            return n.getRect.call(t, ".van-index-anchor-wrapper").then(function(t) {
                return {
                    height: t.height,
                    top: t.top
                };
